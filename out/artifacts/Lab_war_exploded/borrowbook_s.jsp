                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div style="margin-left:20px;margin-top:225px">
                                <a href="BorrowbookServlet"><button type="button" class="am-btn am-btn-warning" style="width: 265px;height: 50px;font-size: 16px;border: 1px rgba(0, 255, 21, 0.5) solid;margin: 0 auto;border-radius: 5px;">
