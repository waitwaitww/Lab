        ...
        <div class="main-content">
            ...
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="deletepost.jsp">删除公告</a></li>
                                        ...
                                        <div class="widget-main">
                                            ...
                                            <div class="step-content row-fluid position-relative" id="step-container">
                                                ...
                                                <div class="step-pane active" id="step1">
                                                    ...
                                                    <form class="form-horizontal" id="adimnistrator-form">
                                                ...
                                                <div class="step-pane" id="step2">
                                                    ...
                                                    <form class="form-horizontal" id="book-form">
                                                        ...
                                                        <div class="form-group has-info">
                                                            ...
                                                            <label for="Pno" class="col-xs-12 col-sm-3 control-label no-padding-right">请输入公告编号</label>
                                                            ...
                                                            <div class="col-xs-12 col-sm-5">
                                                                                ...
                                                                                <span class="block input-icon input-icon-right">
                                                                                    ...
                                                                                    <input type="text" id="Pno" name="Pno" class="width-100" />
                                                        ...
                                                        <div class="form-group has-info">
                                                            ...
                                                            <div class="col-xs-12 col-sm-5">
                                                                                ...
                                                                                <span class="block input-icon input-icon-right">
                                                                                    ...
                                                                                    <input type="text" id="Ptitle" class="width-100" />
...
<script type="text/javascript">
    ...
    jQuery(function($) {
        ...
        $('#fuelux-wizard').ace_wizard().on('change' , function(e, info){
            ...
            location.href = "deletepostServlet?Pno="+Pno;
