...
@WebServlet(name = "returnbooklistServlet")
public class returnbooklistServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("returnbookindex.jsp").forward(request,response);
    }
}
